    ...
    success:function(data){
      ...
      <tr id="R${++rowIdx}">
        ...
        <td class="row-index" id="subtotal" name="subtotal">
          ${parseInt($('#cantidad').val())*parseInt($('#costo').val())}
        </td>
...
$('#facturar-compra').on('click', function(e){
  $('#buscar').prop('hidden', true);
  $('#addBtn').prop('hidden', true);
  $('#facturar-compra').prop('hidden', true);
  $('#cancel').prop('hidden', true);
  $('#producto').prop('hidden', true);
  $('#cantidad').prop('hidden', true);
  $('#unidad_medida').prop('hidden', true);
  $('#costo').prop('hidden', true);
  $('#modif').prop('hidden', true);  
